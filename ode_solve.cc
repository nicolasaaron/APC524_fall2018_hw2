...
int main(int argc, char *argv[]) {
  ...
  else{cout<<"Equation should be 'linear' or 'lorenz' or 'duffing'"<<endl; return 1;}
 ...
 Integrator *first_step_integrator;
  ...
  if(integrator_type=="euler"){
    ...
    first_step_integrator = new RungeKutta4(dt, *model);
    integrator=  new AdamsBashforth(dt, *model, first_step_integrator);
  }
  else{cout<<"Integrator should be 'euler' or 'rk4' or 'ab2'"<<endl; return 1;}
